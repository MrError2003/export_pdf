...
$sql = "SELECT id, number_id, first_name, second_name, first_last, second_last FROM propietarios";
...
// Consulta para obtener la propiedad correspondiente al propietario
$sqlPropiedad = "SELECT * FROM propiedades_inmuebles WHERE propietario_number_id = '" . $number_id . "'";
...
<body>
    ...
    <strong>'. $first_name .' '. $second_name .' '. $first_last .' '. $second_last .'</strong>
    <p>C.C. '. $number_id .'</p>
    <p>Propietario</p>
